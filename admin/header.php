            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="berita.php"><i class="glyphicon glyphicon-globe"></i><span> Berita</span></a>
                        </li>
                        <li><a class="ajax-link" href="partai.php"><i class="glyphicon glyphicon-list-alt"></i><span> Partai</span></a>
                        </li>
                        <li><a class="ajax-link" href="caleg.php"><i class="glyphicon glyphicon-edit"></i><span> Caleg</span></a>
                        </li>
                        <li><a class="ajax-link" href="voter.php"><i class="glyphicon glyphicon-edit"></i><span> Voter</span></a>
                        </li>
                        <li><a class="ajax-link" href="voting.php"><i class="glyphicon glyphicon-edit"></i><span> Voting</span></a>
                        </li>
                        <!--
